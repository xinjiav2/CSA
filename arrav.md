...
I moved my gamified lesson hub to its own page so I can keep adding more interactive MCQ content.

<div style="margin: 1rem 0 2rem; padding: 1rem; border-radius: 14px; border: 1px solid rgba(148,163,184,0.25); background: linear-gradient(135deg, rgba(30,41,59,0.95), rgba(15,23,42,0.95)); max-width: 760px;">
    <h4 style="margin: 0 0 0.5rem; color: #f8fafc;">Lesson Arcade</h4>
    <p style="margin: 0 0 0.85rem; color: rgba(226,232,240,0.92);">Play the new gamified MCQ lessons with XP, streaks, and lesson unlocks.</p>
    <a href="{{site.baseurl}}/lesson-arcade/" style="display: inline-block; text-decoration: none; font-weight: 800; color: #0f172a; background: linear-gradient(135deg, #facc15, #fb7185); padding: 0.6rem 1rem; border-radius: 10px;">Launch Lesson Arcade</a>
</div>
...
<div class="unit-progress-widget">
    <div class="unit-row">
        <div class="unit-row-head">
            <span>Unit 1</span>
            <span>80%</span>
        </div>
        <div class="unit-meter"><span style="width: 80%"></span></div>
        <small>Mostly done, polishing remaining items</small>
    </div>
    ...
    <div class="unit-row">
        ...
        <div class="unit-meter"><span style="width: 100%"></span></div>
    ...
    <div class="unit-row">
        ...
        <div class="unit-meter"><span style="width: 35%"></span></div>
        <small>Started early lessons (3.1, 3.2, 3.4)</small>
    </div>
</div>
